...
print("My name is \(jacob.name). I am \(jacob.age), weigh \(jacob.weight) lbs and am \(jacob.height) inches tall. On an actvity scale from 1-10 I am probably a \(jacob.activityLevel)")
